...
export interface IGenericService<T> {
    ...
    findOne(id: string | null, criteria?: any, select?: any): Promise<T>;
...
export class GenericService<T> implements IGenericService<T> {
    ...
    async findOne(id: string | null, criteria?: any, select?: any): Promise<T> {
        return await this.repository.findOne(id, criteria, select)
    }
